...
{
    public partial class ch11 : Form
    {
        public ch11()
        {
            InitializeComponent();
        ...
        private void ch11_Load(object sender, EventArgs e)
        {
        ...
        private void cmdWord_Click(object sender, EventArgs e)
        {
            ...
            opd.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch11\Word";
        ...
        {
            OpenFileDialog opd = new OpenFileDialog();
            opd.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch11\Image";
            if (opd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                string filepath = opd.FileName;
                Process.Start(filepath);
        ...
        private void cmdCopy_Click(object sender, EventArgs e)
        {
            ...
            f.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch11";
