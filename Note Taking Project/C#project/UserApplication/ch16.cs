...
{
    public partial class ch16 : Form
    {
        public ch16()
        {
            InitializeComponent();
        ...
        private void ch16_Load(object sender, EventArgs e)
        {
        ...
        private void cmdWord_Click(object sender, EventArgs e)
        {
            ...
            opd.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch16\Word";
        ...
        {
            OpenFileDialog opd = new OpenFileDialog();
            opd.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch16\Image";
            if (opd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                string filepath = opd.FileName;
                Process.Start(filepath);
        ...
        private void cmdCopy_Click(object sender, EventArgs e)
        {
            ...
            f.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch16";
