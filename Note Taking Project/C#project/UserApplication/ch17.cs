...
namespace WindowsFormsApplication1
{
    public partial class ch17 : Form
    {
        ...
        private void ch17_Load(object sender, EventArgs e)
        {
        ...
        private void cmdWord_Click(object sender, EventArgs e)
        {
            ...
            opd.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch17\Word";
        ...
        {
            OpenFileDialog opd = new OpenFileDialog();
            opd.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch17\Image";
            if (opd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                string filepath = opd.FileName;
                Process.Start(filepath);
        ...
        private void cmdCopy_Click(object sender, EventArgs e)
        {
            ...
            f.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch17";
