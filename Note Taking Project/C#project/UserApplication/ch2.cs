...
namespace WindowsFormsApplication1
{
    public partial class ch2 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            label12.Text = "Using the \n(1) ?? (Null Coalescing) Operator \n(2) :: (Scope Resolution) Operator \n(3)is and as Operator";
        ...
        private void cmdWord_Click(object sender, EventArgs e)
        {
            ...
            opd.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch2\Word";
        ...
        {
            OpenFileDialog opd = new OpenFileDialog();
            opd.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch2\Image";
            if (opd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                string filepath = opd.FileName;
                Process.Start(filepath);
        ...
        private void cmdCopy_Click(object sender, EventArgs e)
        {
            ...
            f.InitialDirectory = @"C:\Users\PERSONAL\Desktop\c#\ch2";
