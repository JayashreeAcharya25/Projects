     <?php 
            ...
            $result511 = $connect->query("SELECT * FROM feedback");

            if(isset($_POST["sub"]))
{

$name1="Complaint CLosed for Further Details visit Nearest Station";
$sql = "UPDATE feedback SET cstatus='$name1' WHERE id='$_POST[didval]'";

  if($connect->query($sql) === TRUE) {

           $sql = "SELECT * FROM feedback  WHERE id='$_POST[didval]'";
...
require 'class/class.phpmailer.php';
 ...
 foreach ($result as $data) {
    ...
    $mail ->Host = "smtp.gmail.com";
     ...
     $mail ->Username = "jayaacharya1997@gmail.com";
   $mail ->Password = "jayakhosabettu";
    ...
    //$mail->FromName = 'Webslesson';         //Sets the From name of the message
     $mail ->SetFrom("jayaacharya1997@gmail.com","Jayashree");
