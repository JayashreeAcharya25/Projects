    ...
    return (
      <nav className="navbar navbar-default navbar-expand-md fixed-top navbar-trans navf">
        <div className="container">
          ...
          <a className="logo top1" href="/main/dashboard">
          ...
          >
            <ul className="navbar-nav">
              <li className="nav-item">
                <a className="nav-link " href="/main/dashboard">
                  Home
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link " href="/main/show_gemploye">
                Officials
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link " href="/main/show_scholership">
                 Schemes
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link " href="/main/show_category">
                 Categories
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link " href="/main/show_user">
                 Users
                </a>
              </li>
